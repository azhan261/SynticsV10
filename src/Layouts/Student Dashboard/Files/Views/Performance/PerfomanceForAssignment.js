    ...
    return (
        ...
        <div id="content">
          ...
          <div className="containerBlackDashboard-fluid">
            {/* Page Heading */}
            <h1 className='text-center display-2 my-3' style={{ color:'#33334d', fontWeight:'900' }}>Performance Assignments</h1>
            {/* DataTales Example */}
            <div className="card shadow mb-4 text-center">
              ...
              <div className="card-body">
                  <Bar 
                    data = {{
                        labels: ['Deep Learning', 'Python', 'Data-structures ', 'Intro to Artificial Intelligence', 'Advanced Python Libraries', 'Machine Learning',],
                        datasets: [{
