...
function AnswerQueryForManager() {
  ...
  const log = (data) => {
      if (editorRef.current) {
        data.responseContent = editorRef.current.getContent({ format: "text" });
      ...
      <div>
        ...
        <div id="content">
          ...
          <div className="containerBlackDashboard-fluid">
            {/* Page Heading */}
            <h1 className='text-center display-2 my-3' style={{ color:'#33334d', fontWeight:'900' }}>Query Answer Panel</h1>
            {/* DataTales Example */}
